                ...
                <div className='flex flex-col items-center gap-12 lg:flex-row lg:gap-16'>
                    ...
                    <div className='flex-1 space-y-6'>
                        ...
                        <p className='text-muted-foreground max-w-2xl text-lg leading-relaxed'>
                            Fondée en 2003, <span className='text-primary font-semibold'>Dan Systèmes</span> est une
                            entreprise à taille humaine spécialisée dans la revente et l&apos;intégration de solutions
                            IT.
                        </p>

                        <p className='text-muted-foreground max-w-2xl text-lg leading-relaxed'>
                            Depuis plus de deux décennies, nous accompagnons nos clients avec un souci constant de{' '}
                            <span className='text-accent font-medium'>performance</span>, d&apos;
                            <span className='text-accent font-medium'>innovation</span> et de{' '}
                            <span className='text-accent font-medium'>satisfaction</span>.
                        </p>

                        <p className='text-muted-foreground max-w-2xl text-lg leading-relaxed'>
                            Notre dimension humaine est un véritable atout pour offrir un service personnalisé et
                            cultiver une relation de confiance. Traverser toutes ces années en évoluant avec les besoins
                            du marché est pour nous un gage de sérieux et de fiabilité.
                        </p>
                    </div>
                            ...
                            <CardContent className='p-8'>
                                <div className='grid grid-cols-2 gap-6'>
                                    {highlights.map((item, index) => (
                                        <div
                                            key={index}
                                            className='group hover:bg-muted/50 flex flex-col items-center rounded-xl p-4 text-center transition-colors'>
