              ...
              {logos.map((item, index) => (
                ...
                >
                  {variant === 'logo' && item.svg ? (
                    <div
                      className='relative flex h-8 w-full max-w-[100px] items-center justify-center opacity-70 grayscale transition-all duration-300 [&>svg]:max-h-full [&>svg]:max-w-full [&>svg]:object-contain group-hover:opacity-100 group-hover:grayscale-0 sm:h-10 sm:max-w-[120px] md:h-12 md:max-w-[140px]'
