...
const BenefitSection: React.FC<Props> = ({ benefit, imageAtRight, isLast }: Props) => {
    ...
    return (
        <section className={clsx('benefit-section py-16', !isLast && 'border-primary border-b-4')}>
            <motion.div
                className='mx-auto flex max-w-6xl flex-col flex-wrap items-center justify-center gap-2 px-4 lg:flex-row lg:flex-nowrap lg:gap-20'
