    ...
    return (
        <section className='relative flex items-center justify-center px-5 py-16 md:py-24'>
            <div className='absolute top-0 bottom-0 left-0 -z-10 w-full'>
                <div className='bg-hero-background absolute inset-0 h-full w-full bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] mask-[radial-gradient(ellipse_50%_50%_at_50%_50%,#000_60%,transparent_100%)] bg-size-[40px_40px]'></div>
            </div>
